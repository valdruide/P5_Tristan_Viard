...
const productPage = {
      ...
      getProducts: async function () {
            //Affiche le produit en fonction de son ID (productId)
            try {
      ...
      printColors: function (products) {
            //Créé une nouvelle option de couleur dans l'HTML pour chaque couleurs disponibles de l'article
...
cartButton.onclick = function () {
      //Stoque dans le localStorage la quantité, la couleur, et l'ID du produit
      ...
      if (quantityInput > 100) {
            return alert('Vous ne pouvez ajouter que 100 produits du même type maximum');
      }
      const cart = {
